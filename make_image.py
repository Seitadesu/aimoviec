...
def create_image(text, select_color, select_font, random_number):
                API_KEY = "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"
                ...
                image_url = generate_image_with_dalle2(f'{text_en}', './static/image/generate/aititle'+str(random_number)+'.png')
